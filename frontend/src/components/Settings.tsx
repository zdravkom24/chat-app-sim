        ...
        <div className="space-y-4 px-6 py-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-app-primary focus:outline-none"
              placeholder="http://host.docker.internal:4091/api/webhook"
            />
            <p className="mt-1 text-xs text-gray-500">The URL to send inbound webhooks to</p>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label htmlFor="auto_status" className="text-sm text-gray-700">
